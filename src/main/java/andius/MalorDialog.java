...
public class MalorDialog extends Window implements Constants {
    ...
    public MalorDialog(CharacterRecord caster, BaseScreen screen) {
        ...
        scrollPane.add("Enter the desired number of steps one wishes to travel as East (+) West (-), North (-) South (+) and vertical directions as X,Y,Z.");
    }

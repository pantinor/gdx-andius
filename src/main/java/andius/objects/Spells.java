...
public enum Spells {
    ...
    MOGREF("Body Iron", ClassType.MAGE, 1, Sound.GAZE, Color.BLUE, SpellTarget.CASTER, SpellArea.COMBAT, 0, 0, 2, 95),
    KATINO("Bad Air", ClassType.MAGE, 1, Sound.SLEEP, Color.PURPLE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 0, 86),
    DUMAPIC("Clarity", ClassType.MAGE, 1, Sound.GAZE, Color.BLUE, SpellTarget.NONE, SpellArea.CAMP, 0, 0, 0, 33),
    DILTO("Darkness", ClassType.MAGE, 2, Sound.GAZE, Color.PURPLE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 2, 88),
    SOPIC("Glass", ClassType.MAGE, 2, Sound.GAZE, Color.BLUE, SpellTarget.CASTER, SpellArea.COMBAT, 0, 0, 4, 85),
    MAHALITO("Big fire", ClassType.MAGE, 3, Sound.WIND, Color.RED, SpellTarget.GROUP, SpellArea.COMBAT, 4, 6, 1, 79),
    MOLITO("Spark storm", ClassType.MAGE, 3, Sound.WIND, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 3, 6, 0, 46),
    ...
    LAHALITO("Flame storm", ClassType.MAGE, 4, Sound.WIND, Color.RED, SpellTarget.GROUP, SpellArea.COMBAT, 6, 6, 1, 81),
    ...
    LAKANITO("Suffocation", ClassType.MAGE, 6, Sound.GAZE, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 0, 28),
    ZILWAN("Dispel", ClassType.MAGE, 6, Sound.GAZE, Color.YELLOW, SpellTarget.MONSTER, SpellArea.COMBAT, 10, 200, 0, 14),
    MASOPIC("Big glass", ClassType.MAGE, 6, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 4, 5),
    HAMAN("Change", ClassType.MAGE, 6, Sound.GAZE, Color.BLUE, SpellTarget.VARIABLE, SpellArea.COMBAT, 0, 0, 0, 72),
    MALOR("Apport", ClassType.MAGE, 7, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT_OR_CAMP, 0, 0, 0, 94),
    MAHAMAN("Great Change", ClassType.MAGE, 7, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 0, 18),
    TILTOWAIT("(Untranslatable)", ClassType.MAGE, 7, Sound.TREMOR, Color.RED, SpellTarget.GROUP, SpellArea.COMBAT, 10, 15, 0, 63),
    //
    KALKI("Blessings", ClassType.CLERIC, 1, Sound.HEALING, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 1, 95),
    DIOS("Heal", ClassType.CLERIC, 1, Sound.HEALING, Color.BLUE, SpellTarget.PERSON, SpellArea.ANY_TIME, 1, 8, 0, 25),
    BADIOS("Harm", ClassType.CLERIC, 1, Sound.POISON_EFFECT, Color.YELLOW, SpellTarget.MONSTER, SpellArea.COMBAT, 1, 8, 0, 61),
    MILWA("Light", ClassType.CLERIC, 1, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 0, 31),
    PORFIC("Shield", ClassType.CLERIC, 1, Sound.GAZE, Color.BLUE, SpellTarget.CASTER, SpellArea.COMBAT, 0, 0, 4, 5),
    MATU("Blessing & Zeal", ClassType.CLERIC, 2, Sound.HEALING, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 2, 38),
    CALFO("X-ray vision", ClassType.CLERIC, 2, Sound.GAZE, Color.BLUE, SpellTarget.CASTER, SpellArea.LOOTING, 0, 0, 0, 40),
    MANIFO("Statue", ClassType.CLERIC, 2, Sound.GAZE, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 0, 91),
    MONTINO("Still air", ClassType.CLERIC, 2, Sound.GAZE, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 0, 7),
    LOMILWA("More light", ClassType.CLERIC, 3, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 0, 31),
    DIALKO("Softness", ClassType.CLERIC, 3, Sound.GAZE, Color.BLUE, SpellTarget.PERSON, SpellArea.ANY_TIME, 0, 0, 0, 30),
    LATUMAPIC("Identification", ClassType.CLERIC, 3, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 0, 32),
    BAMATU("Prayer", ClassType.CLERIC, 3, Sound.HEALING, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 4, 38),
    DIAL("More Heal", ClassType.CLERIC, 4, Sound.HEALING, Color.BLUE, SpellTarget.PERSON, SpellArea.ANY_TIME, 2, 16, 0, 41),
    BADIAL("More Hurt", ClassType.CLERIC, 4, Sound.SPIRITS, Color.YELLOW, SpellTarget.MONSTER, SpellArea.COMBAT, 2, 8, 0, 44),
    LATUMOFIS("Cure poison", ClassType.CLERIC, 4, Sound.HEALING, Color.GREEN, SpellTarget.PERSON, SpellArea.ANY_TIME, 0, 0, 0, 15),
    MAPORFIC("Big Shield", ClassType.CLERIC, 4, Sound.GAZE, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 2, 352),
    ...
    KANDI("Location", ClassType.CLERIC, 5, Sound.GAZE, Color.BLUE, SpellTarget.PERSON, SpellArea.CAMP, 0, 0, 0, 365),
    ...
    LORTO("Blades", ClassType.CLERIC, 6, Sound.CROSSBOW, Color.GRAY, SpellTarget.GROUP, SpellArea.COMBAT, 6, 6, 0, 62),
    MADI("Healing", ClassType.CLERIC, 6, Sound.HEALING, Color.BLUE, SpellTarget.PERSON, SpellArea.ANY_TIME, 0, 0, 0, 25),
    MABADI("Incredibly Harm", ClassType.CLERIC, 6, Sound.TREMOR, Color.GRAY, SpellTarget.MONSTER, SpellArea.COMBAT, 18, 58, 0, 54),
    LOKTOFEIT("Recall", ClassType.CLERIC, 6, Sound.DIVINE_MEDITATION, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 0, 76),
    MALIKTO("The Word of Death", ClassType.CLERIC, 7, Sound.RAGE, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 12, 6, 0, 59),
    KADORTO("Resurrection", ClassType.CLERIC, 7, Sound.DIVINE_INTERVENTION, Color.BLUE, SpellTarget.PERSON, SpellArea.ANY_TIME, 0, 0, 0, 24);

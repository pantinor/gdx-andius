...
public enum Spells {
    ...
    MILWA("Light", ClassType.CLERIC, 1, Sound.MAGIC, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 0, 31),
    PORFIC("Shield", ClassType.CLERIC, 1, Sound.POWER_CHAINS, Color.BLUE, SpellTarget.CASTER, SpellArea.COMBAT, 0, 0, 4, 5),
    MATU("Blessing & Zeal", ClassType.CLERIC, 2, Sound.HEALING, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 2, 38),
    CALFO("X-ray vision", ClassType.CLERIC, 2, Sound.DIVINE_MEDITATION, Color.BLUE, SpellTarget.CASTER, SpellArea.LOOTING, 0, 0, 0, 40),
    MANIFO("Statue", ClassType.CLERIC, 2, Sound.POWER_CHAINS, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 0, 91),
    MONTINO("Still air", ClassType.CLERIC, 2, Sound.SLEEP, Color.BLUE, SpellTarget.GROUP, SpellArea.COMBAT, 0, 0, 0, 7),
    LOMILWA("More light", ClassType.CLERIC, 3, Sound.MAGIC, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 0, 31),
    DIALKO("Dispel effects", ClassType.CLERIC, 3, Sound.DIVINE_INTERVENTION, Color.BLUE, SpellTarget.PERSON, SpellArea.ANY_TIME, 0, 0, 0, 30),
    LATUMAPIC("Dispel group effects", ClassType.CLERIC, 3, Sound.DIVINE_INTERVENTION, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 0, 32),
    ...
    MAPORFIC("Big Shield", ClassType.CLERIC, 4, Sound.POWER_CHAINS, Color.BLUE, SpellTarget.PARTY, SpellArea.ANY_TIME, 0, 0, 2, 352),
    ...
    KANDI("Location", ClassType.CLERIC, 5, Sound.MEDITATION, Color.BLUE, SpellTarget.PERSON, SpellArea.CAMP, 0, 0, 0, 365),
    ...
    LOKTOFEIT("Recall", ClassType.CLERIC, 6, Sound.MEDITATION, Color.BLUE, SpellTarget.PARTY, SpellArea.COMBAT, 0, 0, 0, 76),

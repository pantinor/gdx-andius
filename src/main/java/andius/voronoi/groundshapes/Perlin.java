...
/**
 * Code from article
 * <a href="http://devmag.org.za/2009/04/25/perlin-noise/">How to Use Perlin
 * Noise in Your, GamesHerman Tulleken</a>.
 *
...
public class Perlin implements HeightAlgorithm {
    ...
    /**
     *
     * @param baseNoise Noise map which will be used to create a smoother noise
     * map.
    ...
    /**
     * Function returns a linear interpolation between two values. Essentially,
     * the closer alpha is to 0, the closer the resulting value will be to x0;

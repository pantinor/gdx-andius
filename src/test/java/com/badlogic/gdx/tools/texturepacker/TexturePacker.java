...
public class TexturePacker {
    ...
    /**
     * @param rootDir Used to strip the root directory prefix from image file
     * names, can be null.
     */
    ...
    public void packImagesOnly(String name, List<BufferedImage> imageContainer) {
        ...
        for (int i = 0, n = settings.scale.length; i < n; i++) {
            ...
            writeImages(name, pages, imageContainer);

            imageProcessor.clear();
        }
    }

    private void writeImages(String imageName, Array<Page> pages, List<BufferedImage> imageContainer) {
    ...
    static public class Rect {
        ...
        /**
         * Clears the image for this rect, which will be loaded from the
         * specified file by {@link #getImage(ImageProcessor)}.
         */
     ...
     * @param output Directory where the pack file and page images will be
     * written.
     * @param packFileName The name of the pack file. Also used to name the page
     * images.
     */
     ...
     * modification date is before the last modification date of the input file
     */
